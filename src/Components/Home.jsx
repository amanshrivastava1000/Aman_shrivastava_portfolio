              ...
              >
                ...
                >
                  ...
                  <Link
                    // m="5px"
                    id="contact-linkedin"
                    href="https://www.linkedin.com/in/aman-shrivastava-99b046231/"
                    target="_blank"
                    _hover={{
                      animation: "4s ease infinite",
                      transform: "scale(1.06)",
                  ...
                  <a href="mailto:amanshrivastav91pp@gmail.com">
                    <Box
                    ...
                    >
                      ...
                      <MdOutlineMailOutline
                        size={25}
                        color={useColorModeValue("white", "rgba(0, 0, 0, 0.7)")}
                      />
                    </Box>
                  </a>
                  <a href="tel:8447374377">
                    <Box
                      bgColor={useColorModeValue("black", "white")}
                      borderRadius="100%"
                      p={2}
