...
const Contact = () => {
  ...
  return (
    <Box id="contact" textAlign="center" pt={{ base: "80px", md: "130px" }} px={4} pb={10}  bg={useColorModeValue("white", "gray.800")} color={useColorModeValue("black", "white")}>
      <Box maxW="90%" mx="auto">
        ...
        <Box mt={{ base: 10, md: 16 }} data-aos="fade-up">
          <Text mb={4} fontSize="lg" color="gray.300">
